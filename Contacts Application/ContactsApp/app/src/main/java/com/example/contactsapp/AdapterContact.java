...
public class AdapterContact extends RecyclerView.Adapter<AdapterContact.ContactViewHolder> {
    ...
    private void MakeCall(String number)
    {
            ...
            Intent callintent = new Intent(Intent.ACTION_VIEW, Uri.parse(dial));
            callintent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            context.getApplicationContext().startActivity(callintent);
    }

    private void MakeText(String phone)
    {
    ...
    public void onBindViewHolder(@NonNull ContactViewHolder holder, int position) {
        ...
        holder.contactDial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Toast.makeText(context.getApplicationContext(), phone, Toast.LENGTH_SHORT).show();
                MakeCall(phone);
            }
        });
        holder.itemView.findViewById(R.id.contact_number_msg).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Toast.makeText(context.getApplicationContext(), phone, Toast.LENGTH_SHORT).show();
                MakeText(phone);
